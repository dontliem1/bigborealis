...
output += t_9;
output += "\n</head>\n<body";
if((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "comingsoon")),"background") && runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "page")),"url") === "/")) {
output += " style='background-image: url(\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "comingsoon")),"background"), env.opts.autoescape);
output += "\")' ";
;
}
output += ">\n  ";
...
output += runtime.suppressValue((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "comingsoon")),"logo")?" visually-hidden":""), env.opts.autoescape);
output += "\">";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "introHeading"), env.opts.autoescape);
output += "</h1>\n";
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "comingsoon")),"logo")) {
output += "\n  <img class='home__logo' src='";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "comingsoon")),"logo"), env.opts.autoescape);
